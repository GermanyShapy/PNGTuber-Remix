...
func _update_ui_state() -> void:
	...
	if _plugin:
		...
		if _http_port_spin:
			_http_port_spin.value = _plugin.http_port if _plugin.get("http_port") != null else 9081
...
func _save_settings() -> void:
	...
	var settings: Dictionary = {
		...
		"http_port": int(_http_port_spin.value) if _http_port_spin else 9081,
